  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="模板分类" prop="templateCategory">
        <el-select
          v-model="queryParams.templateCategory"
          placeholder="模板分类"
          clearable
          size="small"
        >
...
<script>
import { listTask, delTask } from "@/api/sms/task";
...
export default {
  ...
  methods: {
    ...
    categoryFormat(row, column) {
      return this.selectDictLabel(this.categoryOptions, row.templateCategory);
    },
    // 表单重置
    reset() {
      this.form = {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除短信记录编号为"' + taskIds + '"的数据项?', "警告", {
