        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.menuType != 'M'" label="权限标识">
              <el-input v-model="form.menuCode" placeholder="请权限标识" maxlength="50" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getMenu(row.id).then(res => {
        ...
        this.form.isCache = this.form.isCache + '';
        this.form.isVisible = this.form.isVisible + '';
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != undefined) {
            updateMenu(this.form.id, this.form).then(res => {
